...
1. **Get set up.** Each repo has a [README](./glossary.md#readme) with clear instructions on how to get the repo up and running properly. Thanks, [Repository Standards](/repository-standards)!
...
1. **Abide coding and commit standards**. Any specific information necessary to know in this regard should be in the project [README](./glossary.md#readme).
